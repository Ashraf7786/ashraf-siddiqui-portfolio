...
export default function ProjectArchive() {
    ...
    const getPreviewImage = (title: string) => {
        if (title === 'Neuro Spine Solution') return "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=400"; // Medical/Therapy context
