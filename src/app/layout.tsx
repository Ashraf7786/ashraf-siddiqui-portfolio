...
export const metadata: Metadata = {
  ...
  description: "Portfolio of Ashraf Siddiqui, the best Full Stack Web Developer in India. Specialized in React, Next.js, Laravel, PHP, and high-performance scalable web applications for Indian and global clients.",
  keywords: [
    "Ashraf Siddiqui",
